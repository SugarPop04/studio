...
import { CalendarIcon } from "lucide-react"; // Direct import for ShadCN pattern
...
import { patientsData, doctorsData, type Patient, type Doctor } from "@/lib/data"; // For dropdowns

import { createAppointmentAction } from "../actions";
import { NewAppointmentFormSchema, type NewAppointmentFormValues, type CreateAppointmentActionResult } from "../schemas";

// Fetch patient and doctor data (in a real app, this might be an API call)
// For this example, we'll use the imported data directly.
...
export default function NewAppointmentPage() {
  ...
  const form = useForm<NewAppointmentFormValues>({
    ...
    defaultValues: {
      ...
      time: "", // e.g., "10:00"
      type: undefined, // Initialize as undefined for select placeholder
      notes: "",
    },
  });
                      ...
                      <Popover>
                        <PopoverTrigger asChild>
                          <FormControl>
                            ...
                            >
                              {field.value ? (
                                format(field.value, "PPP") // PPP format: Jan 1, 2024
                              ) : (
